...
set shortmess=aoO
badd +1 term://.//15476:yarn\ react-scripts\ start
...
badd +14 src/components/App/index.js
...
badd +30 src/components/Load.js
badd +0 src/components/Graph/index.js
...
set winwidth=1
argglobal
if bufexists('term://.//15476:yarn\ react-scripts\ start') | buffer term://.//15476:yarn\ react-scripts\ start | else | edit term://.//15476:yarn\ react-scripts\ start | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
exe 'vert 4resize ' . ((&columns * 58 + 89) / 178)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
setlocal fen
silent! normal! zE
let s:l = 58 - ((11 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
